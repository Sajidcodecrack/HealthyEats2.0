...
export default function AITutor() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: "Hi there! I'm your AI Nutrition Guide. I can help you with meal planning, nutrition advice, and healthy eating tips. What would you like to know today?"
    }
  ]);
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const response = await fakeAssistantReply(userMessage.content);
  ...
  const fakeAssistantReply = async (text: string): Promise<string> => {
    return new Promise((resolve) =>
      setTimeout(() => {
        resolve(`I recommend focusing on whole foods like fruits, vegetables, lean proteins, and whole grains. For "${text}", try incorporating more fiber-rich foods and staying hydrated throughout the day. Remember that balance is key to sustainable healthy eating!`);
      }, 1500)
    );
  };
          ...
          <View style={styles.headerCenter}>
            ...
            <View>
              ...
              <Text style={styles.headerSubtitle}>
                {isTyping ? 'Analyzing your query...' : 'Your personal wellness assistant'}
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={[styles.inputWrapper, { backgroundColor: colors.inputBackground, borderColor: colors.border }]}>
          ...
          <TouchableOpacity
            style={[
              ...
              (!inputText.trim() || isTyping) && [styles.disabledSendButton, { backgroundColor: colors.disabledButton }]
            ]}
